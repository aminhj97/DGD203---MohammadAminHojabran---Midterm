...
namespace Samurai
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // This is for asking the player's name
            Console.Write("Enter your name, brave samurai: ");
            string playerName = Console.ReadLine();

            Console.WriteLine($"\nGreetings, {playerName}. Your journey as a samurai begins now.\n");

            // This is for saving player's name
            string[] answers = new string[6];

            // These next lines are for all 6 questions of the game
            ...
            // For ending you get by answering messages 
            Console.WriteLine($"\nWell done, {playerName}! Here's how your journey unfolded:");

            // Different outcomes and choices you made through the story
            if (answers[0] == "A")
